...
Check: `git diff --stat 189c0df32617afc488e0f091dbface1bd72cceb4 -- . ':!UNICITY.md' ':!crates/unicity'`
must show exactly the one-line `Cargo.toml` change and the added `Cargo.lock` package entry.
